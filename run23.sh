CWD="/inspire/qb-ilm/project/wuliqifa/yanjunchi-24040/hzwx158/adaptformer"

# MODEL_PRETRAINED="base_augreg_in1k"
# MODEL_PRETRAINED="base_augreg_in21k"
...
do
    if [[ $MODEL_PRETRAINED =~ "resnet" ]]; then
        ...
        MERGED="${CONVERTED}_merge_0.8_no_qk"
        MASK="${CONVERTED}_mask_dict_0.8_no_qk"
    else
        CONVERTED="${MODEL_PRETRAINED}_converted"
